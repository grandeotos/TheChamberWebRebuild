        ...
        <tr>
          ...
          <td>
            <form role="form" action="advancedView" method="POST">
              ...
              <input type="hidden" id="generatedByHidden${status.index}" name="generatedBy" value="${administrador.username} - ${administrador.firstName} ${administrador.lastName}">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form role="form" action="advancedView" method="POST">
          ...
          <input type="hidden" id="generatedByHiddenModal" name="generatedBy" value="${administrador.username} - ${administrador.firstName} ${administrador.lastName}">
